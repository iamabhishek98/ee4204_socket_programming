...
float str_cli(FILE *fp, int sockfd, struct sockaddr *addr, int addrlen);                       //transmission function
...
int main(int argc, char **argv)
{
	...
	str_cli(fp,sockfd,(struct sockaddr *)&ser_addr, sizeof(struct sockaddr_in));
	// ti = str_cli(fp, sockfd);                       //perform the transmission and receiving
